...
<head>
	...
	<title><?= $merchantName ?> Limo Inc Completed Merchant Application Notification</title>
	<style type="text/css">
...
<body marginwidth="0" marginheight="0" style="margin-top: 0; margin-bottom: 0; padding-top: 0; padding-bottom: 0; width: 100%; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%;" offset="0" topmargin="0" leftmargin="0" background="#ffffff">
													...
													<table class="full-width" align="left" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
														<tr>
															<td align="left" style="font-family: 'Roboto', sans-serif; font-size: 14px; font-weight: 400; color: #ffffff; line-height: 24px;">
																Thank you for completing and submitting your Merchant Application to PayMe.Limo. We have successfully onboarded your
																information onto our platform. Upon completion of our internal review process, PayMe.Limo will be emailing you your login
																credentials so that you can begin accepting credit cards through us. Should you have any questions, please contact our
																PayMe.Limo support team at 818-572-2525 and select option #1. Thank you for choosing PayMe.Limo. We look forward to doing
																business with you!
															</td>
														</tr>
														<tr>
