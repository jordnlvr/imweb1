...
class LoginController extends BaseController
{
    ...
    public function loginView()
    {
        ...
        $data['success_message'] = session()->getFlashdata('success');
    ...
    public function loginAction(): RedirectResponse
    {
        ...
        if(auth()->user()->id){
            ...
            $usersData =  $db->table('users')->select('users.id,  ai.name,agu.group')
                ...
                if($usersData){
                    ...
                    $session->set('login_user', $usersData->name);
                    $session->set('user_role', $usersData->group);
                } 
        }
