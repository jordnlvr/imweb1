													...
													<table class="full-width" align="left" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
														<tr>
															<td align="left" style="font-family: 'Roboto', sans-serif; font-size: 14px; font-weight: 400; color: #ffffff; line-height: 24px;">
																Congratulations! Your Merchant Application has been reviewed by our underwriting team and your Merchant Account has been
																approved. Listed below are your login credentials: :
															</td>
														</tr>
														<tr>
														...
														<tr>
															<td align="left" style="font-family: 'Roboto', sans-serif; font-size: 14px; font-weight: 400; color: #ffffff; line-height: 24px;">
																Please click on the Merchant Dashboard Login link below to access the PayMe.Limo platform
															</td>
														</tr>
														<tr>
															<td height="15" style="font-size: 1px; line-height: 15px;">
														...
														<tr>
															<td align="center" style="font-family: 'Roboto', sans-serif; font-size: 16px; font-weight: 400; color: #ffffff; line-height: 24px; text-align: center; width: 100%;">
																<!--[if mso]>
                                                                        ...
                                                                        <tr>
                                                                        <td width="100%" align="center" style="width: 100%; text-align: center;font-size: 16px !important;">
                                                                        <a:roundrect xmlns:a="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="<?= base_url(); ?>" fillcolor="#e4c9aa" arcsize="8%" style="v-text-anchor:middle;width:140pt;height:32pt;" stroke="f"><w:anchorlock/>
                                                                        <a:textbox inset="0,0,0,0">
                                                                        <center style="color:#000000; font-family: 'Roboto', sans-serif; font-size:16px !important;">
                                                                    <![endif]-->

																<a href="<?= base_url(); ?>" style="display: inline-block; background-color: #e4c9aa; color: #000000; line-height: 1.3; margin: 0; text-align: center; text-decoration: none; text-transform: none; padding: 8px 16px 8px 16px; mso-padding-alt: 0px; border-radius: 5px; mso-border-alt: none; box-sizing: content-box; font-family:  'Roboto', sans-serif; font-size: 16px !important;" target="_blank">Merchant Dashboard Login</a>
														...
														<tr>
															<td align="left" style="font-family: 'Roboto', sans-serif; font-size: 14px; font-weight: 400; color: #ffffff; line-height: 24px;">
																Should you have any questions, please contact our PayMe.Limo support team at 818-572-2525 and select option #1. Thank you
																for choosing PayMe.Limo. We look forward to doing business with you!
															</td>
														</tr>
														<tr>
															<td height="15" style="font-size: 1px; line-height: 15px;">
