...
<head>
  ...
  <link rel="shortcut icon" href="<?= base_url('public/assets/images/fav.png'); ?>" type="image/x-icon" />
...
<script>
  ...
  $(".togglePassword").click(function(e) {
    ...
    if (type == "password") {
      $(".togglePassword svg.feather.feather-eye").replaceWith(feather.icons["eye-off"].toSvg());
      $(this).parent().parent().find(".password").attr("type", "text");
    } else if (type == "text") {
      $(".togglePassword svg.feather.feather-eye-off").replaceWith(feather.icons["eye"].toSvg());
  ...
  $(".togglePassword1").click(function(e) {
    e.preventDefault();
    var type = $(this).parent().parent().find(".password_confirm").attr("type");

    if (type == "password") {
      $(".togglePassword1 svg.feather.feather-eye").replaceWith(feather.icons["eye-off"].toSvg());
      $(this).parent().parent().find(".password_confirm").attr("type", "text");
    } else if (type == "text") {
      $(".togglePassword1 svg.feather.feather-eye-off").replaceWith(feather.icons["eye"].toSvg());
      $(this).parent().parent().find(".password_confirm").attr("type", "password");
    }
  });
</script>
